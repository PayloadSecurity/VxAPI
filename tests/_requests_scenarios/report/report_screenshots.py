...
first_image = open('tests/_data/screenshots/image1.png', 'rb')
second_image = open('tests/_data/screenshots/image2.png', 'rb')
...
scenarios = [
    ...
    {
        "url": "/report/test/screenshots",
        "method": "get",
        "status_code": 200,
        "json": [
            {'name': 'image1.png', 'image': base64.b64encode(first_image.read()).decode(), 'date': 'd-m-y'},
            {'name': 'image2.png', 'image': base64.b64encode(second_image.read()).decode(), 'date': 'd-m-y'}
        ],
        "headers": {
            "content-type": "application/json",
            "webservice-version": "8.10",
