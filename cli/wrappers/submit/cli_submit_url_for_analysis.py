...
class CliSubmitUrlForAnalysis(CliCaller):

    help_description = 'Submit an url for analysis by \'{}\''

    def build_argument_builder(self, child_parser):
        return SubmissionCliArguments(child_parser)

    def add_parser_args(self, child_parser):
        parser_argument_builder = super(CliSubmitUrlForAnalysis, self).add_parser_args(child_parser)
